...
import ViewController.MenuPrincipalController;
...
public class TelaPrincipal extends JFrame {
	...
	public TelaPrincipal() {
		...
		mntmNewMenuItem_4.setIcon(new ImageIcon(TelaPrincipal.class.getResource("/img/icon/exchange.png")));
		mnCadastro.add(mntmNewMenuItem_4);
