...
public class Banco {
    ...
    public static void inicia(){
        ...
        User usuario1 = new User(1, "Cleander", 'M', "09/05/1996", "30212121", "cleander@gmail.com", "521454123", " ", "administrador");
        User usuario2 = new User(2, "estagiario", 'M', "09/05/1996", "30212122", "estagiaria@cleander.com", "451244123", "estagiario", "funcionario");
        ...
        Service servico1 = new Service(1, "Limpeza Basica", 18);
        Service servico2 = new Service(2, "Limpeza Pesa", 30);
        Service servico3 = new Service(3, "Limpeza Basica", 15);
        Service servico4 = new Service(4, "Limpeza Pesada", 25);
        Service servico5 = new Service(5, "Limpeza leve", 10);
        Service servico6 = new Service(6, "Limpeza Basica", 3);
        ...
        Scheduling agendamento4 = new Scheduling(4, cliente5, servico1, 18, "14/07/2018 10:30");
